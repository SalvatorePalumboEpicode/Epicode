...
let a = 2;
let b = 3;
let risultato = whoIsBigger ()
console.log('esercizio 2',risultato)
...
/*
function deletOne(stringa, boolean){
      stringa = 'Epicode'
      if (boolean){
...
risultato3 = deletOne('Epicode', true)
console.log(risultato3);
risultato4 = deletOne('Epicode', false)
...
console.log('esercizio 5',risultato4); 
...
ris5 = isThisAnEmail('Salvatore@gmail.com')
console.log('esercizio 6',ris5);

/* ESERCIZIO 7
  Scrivi una funzione chiamata "whatDayIsIt" che ritorna il giorno della settimana corrente.
*/

function whatDayIsIt(giorno){
    let  giornosettimana = [ 'domenica','lunedi', 'martedi', 'mercoledi', 'giovedi', 'venerdi', 'sabato'];
    data = new Date().getDay()
    nomegiorno = giornosettimana[data]
    return nomegiorno
}
risultato6 = whatDayIsIt()
console.log('esercizio 7',risultato6)
...
risultato8 = rollTheDices();
console.log('esercizio 8', risultato8)

/* ESERCIZIO 9
  Scrivi una funzione chiamata "howManyDays" che riceve una data come parametro e ritorna il numero di giorni trascorsi da tale data.
*/

function howManyDays(dayDiff){
  let currentDay = new Date();
  const day = new Date(dayDiff);
  let diffTime = currentDay.getTime() - day.getTime();
  let diffDay = Math.round(diffTime / (1000 * 3600 *24))
  return diffDay;
}

console.log('esercizio 9', howManyDays("13-04-2022"))
...
let myBirthday = new Date('1993-04-13');
let oggiIlMioCompleanno = isTodayMyBirthday(myBirthday);

if (oggiIlMioCompleanno) {
  console.log("Buon compleanno!");
} else {
  console.log('esercizio 10',"Non è il tuo compleanno oggi.");
}
...
console.log('esercizio 12', newestMovie(movie))
...
function onlyInLastMillennium() {
  const lastMillenniumMovies = movies.filter(movie => parseInt(movie.Year) < 2000);
  return lastMillenniumMovies;
}

const millenniumMovies = onlyInLastMillennium();
console.log("Film prodotti nel millennio scorso:", millenniumMovies);
...
const totalYearsSum = sumAllTheYears();
console.log("Somma di tutti gli anni di produzione:", totalYearsSum);
