...
for (let i = 1; i < starWarsCharacters.lenght; i++) {
...
function checkCargoType(totalMass) {
  switch(true) {
    case totalMass < 500:
...
checkCargoType(totalMass);
// Modifica la massa di un personaggio
starWarsCharacters[0].mass = 450;

// Ricalcola la massa totale
totalMass = 0;
for (const character of starWarsCharacters) {
  totalMass += character.mass;
}
